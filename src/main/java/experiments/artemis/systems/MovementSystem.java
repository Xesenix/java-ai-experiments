...
public class MovementSystem extends IntervalEntityProcessingSystem
{
	...
	protected void process(Entity e)
	{
		...
		if (worldPosition.getPosition() instanceof Position)
		{
			...
			double dx = Math.cos(direction.getDirectionRadians()) * speed.getSpeed() * world.getDelta();
			double dy = Math.sin(direction.getDirectionRadians()) * speed.getSpeed() * world.getDelta();
